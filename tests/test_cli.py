...
def test_cli_colors_with_more_levels_than_groups(tmp_path, monkeypatch, capsys):
    ...
    assert color1.read_text() == "// Generated by gitshelves\nL1"
    assert color2.read_text() == "// Generated by gitshelves\nL2"
    assert color3.read_text() == "// Generated by gitshelves\nL3"
    assert color4.read_text() == "// Generated by gitshelves\nL4\nL5"
