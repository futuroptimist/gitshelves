...
The command will create `contributions.scad` (and optionally `contributions.stl`) in the current directory. Months are arranged in rows of ten by default, but you can choose the grid width via `--months-per-row`.
