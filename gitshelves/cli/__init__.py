...
DEFAULT_CALENDAR_DAYS_PER_ROW_CAP = 12

__all__ = ["main", "DEFAULT_CALENDAR_DAYS_PER_ROW_CAP"]
...
def main(argv: list[str] | None = None):
    ...
    if args.calendar_days_per_row is None:
        args.calendar_days_per_row = min(
            args.months_per_row, DEFAULT_CALENDAR_DAYS_PER_ROW_CAP
        )
